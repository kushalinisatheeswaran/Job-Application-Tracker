      ...
      <main className="flex-1">
        <section className="container mx-auto px-4 py-32">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-muted-foreground mb-10 text-xl">Capture, organize, and manage all your job applications in one place.</p>
          <div className="flex flex-col items-center gap-4">
            <Link href="/sign-up">
             <Button size="lg" className="h-12 px-8 text-lg font-medium">Start for free <ArrowRight className="ml-2 h-4 w-4" /> </Button>
            </Link>
